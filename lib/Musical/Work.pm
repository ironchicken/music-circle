...
package Musical::Work {
    ...
    # This package defines the Musical::Work class which corresponds
    # with the Music Ontology class mo:MusicalWork.
    ...
    with ('MooseX::Semantic::Role::RdfImport',
          ...
          'StagedConstruction' => { stages => ['DeserializeWork', 'UseExistingWork'] });
...
package UseExistingWork {
    ...
    # construction workflow making use of external authorities on
    # musical works to attempt to uniquely identify the musical work
    # the client is attempting to create.
